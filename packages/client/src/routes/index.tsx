...
const HINT_QUERIES = [
  "мужчина в рваной одежде идёт по пустыне",
  "мальчик падает на надувную пирамиду",
  "мужчины борются в подвале",
  "девушка-колясочница веселится на дискотеке",
  "мужчины обсуждают визитки",
  "20 век фокс",
  "мужчина в торговом центре нейтрализует ниндзя",
  "пальчиковый захват уси",
  "зелёное чудовище выходит из деревенского туалета",
];
