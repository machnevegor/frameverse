...
# ASR
ASR_SILENCE_GAP_SEC = 2

# Shot boundary detection
SBD_THRESHOLD = 50
SBD_MIN_SCENE_DURATION_SEC = 10
...
KEYFRAMES_EXTRACTION_TIMEOUT_SEC = 20
...
# Annotation
ANN_CONCURRENCY = 25
ANN_PREVIOUS_SCENES_CONTEXT_NUM = 3
ANN_TRANSCRIPT_SIDE_CONTEXT_SEC = 5
...
# Search
SEARCH_TRANSCRIPT_CANDIDATES = 20
SEARCH_ANNOTATION_CANDIDATES = 15
SEARCH_IMAGE_CANDIDATES = 5
SEARCH_MAX_MOVIE_GROUPS = 4
SEARCH_MAX_SCENES_PER_GROUP = 3
SEARCH_MAX_LLM_ITERATIONS = 3
SEARCH_LLM_MAX_TOKENS = 25000
SEARCH_LLM_MAX_SCENES = 40
SEARCH_LLM_MAX_IMAGES = 6  # total images across all ReAct iterations
SEARCH_SCORE_THRESHOLD = 0.5
SEARCH_IMAGE_THRESHOLD = 0.7
